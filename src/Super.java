...
public abstract class Super {
    static void printCategories(List<Category> categoryList) {
    ...
    static void printProductsInCategory(String choice, List<Category> categoryList, List<Product> products) {
    ...
    static void search(Scanner sc, List<Category> categoryList, List<Product> products) {
        System.out.println("""
    ...
    static void addNewCategory(List<Category> categoryList, Scanner sc) {
        System.out.println("Insert the name of the new category:");
        categoryList.add(new Category(sc.nextLine()));
    }

    static void addProduct(Scanner sc, List<Category> categoryList, List<Product> products) {
        String choice;
        Print.productMenu(categoryList);
        choice = sc.nextLine();
        try {
    ...
    static void productsBalance(Scanner sc, List<Category> categoryList, List<Product> products) {
        products.forEach(System.out::println);
    }

    static void deleteCategory(Scanner sc, List<Category> categoryList, List<Product> products) {
        String choice;
    ...
    static void removeProduct(Scanner sc, List<Category> categoryList, List<Product> products) {
        if (products.size() == 0)
    ...
    static void editStock(Scanner sc, List<Category> categoryList, List<Product> products) {
        if (products.size() == 0)
            System.out.println("""
